...
/**
 * Consolidate players to highest courts when total < 16
 * Ensures all players can continue playing by using only highest courts
 * @param {Array} courtAssignments - Array of 4 court arrays
